...
fileName = os.path.split(os.path.splitext(os.getcwd())[0])[1][:-5] + '_omegaATT'
imageToVTK(fileName, origin=(xmin, ymin, zmin), spacing=(
...
fileName = os.path.split(os.path.splitext(os.getcwd())[0])[1][:-5] + '_aFTLEATT'
imageToVTK(fileName, origin=(xmin, ymin, zmin), spacing=(
