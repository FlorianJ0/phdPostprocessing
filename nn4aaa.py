...
def score(y_test, y_pred):
    ...
    print 'ROC_score=== ', roc_auc_score(np.array(y_test).astype(int), np.array(y_pred))
    print 'cohen_kappa_score=== ', cohen_kappa_score(np.array(y_test).astype(int), np.array(y_pred))
    print 'f1_score=== ', f1_score(np.array(y_test).astype(int), np.array(y_pred))
    return
